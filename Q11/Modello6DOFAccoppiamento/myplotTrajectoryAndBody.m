function myplotTrajectoryAndBody(h_fig,vXe,vYe,vZe,vQuat,scale_factor,step,theView,varargin)
%
...
if isscalar(step)
    ...
    for i=1:step:(length(vXe)-usr_modulo)
        ...
        quiver3( ...
            ...
            Xb(1),Xb(2),Xb(3), ...
            'color',[1, 0.0780, 0.1840],'linewidth',2.5 ...
        ); hold on
        quiver3( ...
            P_on_traj(1),P_on_traj(2),P_on_traj(3), ...
            Yb(1),Yb(2),Yb(3), ...
        ...
        quiver3( ...
            P_on_traj(1),P_on_traj(2),P_on_traj(3), ...
            Zb(1),Zb(2),Zb(3), ...
            'color',[0.1660, 0.8740, 0.1880],'linewidth',2.5 ...
        ); hold on
...
%% The visualization loop
    ...
    for is=1:length(step)
        ...
        quiver3( ...
            P_on_traj(1),P_on_traj(2),P_on_traj(3), ...
            0.65*Xb(1),0.65*Xb(2),0.65*Xb(3), ...
            'color',[0.6350, 0.0780, 0.1840],'linewidth',1.5 ...
        ); hold on
        quiver3( ...
            P_on_traj(1),P_on_traj(2),P_on_traj(3), ...
            0.6*Yb(1),0.6*Yb(2),0.6*Yb(3), ...
            'color',[0, 0.4470, 0.7410],'linewidth',1.5 ...
        ); hold on
        quiver3( ...
            P_on_traj(1),P_on_traj(2),P_on_traj(3), ...
            0.6*Zb(1),0.6*Zb(2),0.6*Zb(3), ...
...
h_fig = plot3(vXe, vYe, vZe, 'k', 'linewidth', 0.7); % 3D trajectory
...
xlabel('$x_{E} (m)$','interpreter','latex','fontsize',11); 
ylabel('$y_{E} (m)$','interpreter','latex','fontsize',11); 
zlabel('$z_{E} (m)$','interpreter','latex','fontsize',11);
