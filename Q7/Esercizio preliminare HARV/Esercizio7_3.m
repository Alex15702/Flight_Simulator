...
t_fin = 280; %Tempo di simulazione [s] (Manovra di avvicinamento alla pista di atterraggio di un aeroporto)
...
delta_a_exc1 = convang(-20,'deg','rad');
...
delta_r_exc1 = convang(10,'deg','rad');
