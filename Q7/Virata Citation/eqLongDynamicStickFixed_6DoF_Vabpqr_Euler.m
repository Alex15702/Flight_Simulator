function [dStatedt] = eqLongDynamicStickFixed_6DoF_Vabpqr_Euler(t,state)

global g...
       delta_a delta_e delta_r delta_T delta_f ...
       myAC
...
C_L=CL(convang(alpha_B,'rad','deg'),...
                          convang(delta_e(t),'rad','deg'), convang(delta_f(t),'rad','deg'));
